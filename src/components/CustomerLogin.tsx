...
import { Milk, ArrowRight, Lock, AlertCircle, RefreshCw, Phone } from 'lucide-react';
...
export default function CustomerLogin() {
  ...
  const handleCustomerAuth = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (msg.includes('auth/user-not-found')) msg = "Customer not registered.";
      setError(msg);
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white border border-slate-200 overflow-hidden">
        ...
        <div className="bg-orange-500 p-8 text-center relative overflow-hidden">
          ...
          <p className="text-orange-100 text-sm mt-1 relative z-10">Customer Portal</p>
        </div>
          ...
          <div>
            ...
            <form onSubmit={handleCustomerAuth} className="space-y-4">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-none py-3 pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-transparent"
                    value={mobile}
                    onChange={e => {
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    maxLength={4}
                    placeholder="••••"
                    className="w-full bg-slate-50 border border-slate-200 rounded-none py-3 pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-transparent tracking-widest"
                    value={pin}
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-orange-500 text-white rounded-none py-3 flex items-center justify-center gap-2 hover:bg-orange-600 disabled:opacity-70 mt-2 text-sm"
              >
                {loading ? (
