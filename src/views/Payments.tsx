    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button 
          ...
          className="xl:hidden bg-blue-600 text-white px-3 py-2 text-xs flex items-center gap-1 shrink-0 shadow-sm"
        >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 items-start">
                  ...
                  {formData.personId && (
                    <div className="mt-2 p-3 bg-indigo-50/50 border border-indigo-100 flex justify-between items-center">
                      <div>
                        ...
                        <p className={` text-sm ${
                          (formData.personType === 'farmer' ? farmers.find(f => f.id === formData.personId)?.balance : customers.find(c => c.id === formData.personId)?.balance) >= 0 
        ...
        <div className="xl:col-span-8 space-y-4">
          ...
          <div className="bg-white rounded-none border border-slate-200 overflow-hidden">
            ...
            <div className="max-h-[600px] overflow-y-auto overflow-x-auto bg-slate-50 md:bg-white border-t border-slate-100">
              {/* Desktop View */}
              <table className="w-full text-left border-collapse whitespace-nowrap hidden md:table">
                <thead className="bg-slate-50 text-black uppercase text-[9px] tracking-widest  sticky top-0 z-10">
                  <tr>
