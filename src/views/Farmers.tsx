              ...
              <table className="w-full xl:w-max text-left border-collapse min-w-[800px] relative">
                <thead className="sticky top-0 z-10 bg-slate-50 border-b border-slate-100 shadow-sm">
                  <tr className="bg-slate-50 border-b border-slate-100">
                    ...
                    <th className="px-2 md:px-6 py-3 md:py-4 text-[10px] text-black font-semibold capitalize tracking-widest whitespace-nowrap">{t('farmer')}</th>
                    ...
                    <th className="px-2 md:px-6 py-3 md:py-4 text-[10px] text-black font-semibold capitalize tracking-widest whitespace-nowrap">{t('village')}</th>
